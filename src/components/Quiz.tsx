...
export default function Quiz() {
  ...
  const submit = async () => {
    setSubmitting(true);
    try {
      const SHEET_WEBHOOK = "https://script.google.com/macros/s/AKfycbwxQoo6BhDzF5DDCjCDvCiOSj-J67hE7DZwBrq9J28ZS3wAotHHKFfC0cYLAdQ60wxg/exec";
      if (SHEET_WEBHOOK) {
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-3 max-w-lg mx-auto">
          {isHotLead
            ...
            : "Seu perfil tem potencial. Vamos conversar rapidamente para entender como aplicar a estratégia certa na sua clínica."}
        </p>
      </div>
